            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl md:text-3xl font-heading font-black text-white mb-3 group-hover:text-olive-light transition-colors">{t.objectSimulator}</h3>
                  <p className="text-base text-gray-300 font-serif leading-relaxed opacity-90">{t.objectSimulatorDesc}</p>
                </div>
              </button>
            ...
            <p className="text-center text-inkLight dark:text-gray-400 mb-12 font-serif text-xl px-4">{t.streamSelectDesc}</p>
             ...
             {calcMode === 'continuous' && (
                <div className="max-w-xl mx-auto mb-16 relative">
                    <div className="absolute -inset-2  bg-blue-200 dark:bg-black  rounded-[2.5rem] blur-xl "></div>
